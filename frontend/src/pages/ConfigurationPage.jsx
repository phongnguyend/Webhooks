...
export default function ConfigurationPage({ tenants, selectedTenantId, setSelectedTenantId, selectedTenant, topics, loading, copied, copy, setDialog, toggleTenant, deleteTenant, toggleTopic, deleteTopic }) {
  return (
