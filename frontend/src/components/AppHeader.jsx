import { Eye, Settings2, Webhook } from 'lucide-react'
...
<header className="topbar">
        ...
        <nav className="tabs" aria-label="Primary navigation">
          ...
          {user.roles?.includes('Global Admin') && <button className={view === 'users' ? 'active' : ''} onClick={() => onViewChange('users')}>Users</button>}
        </nav>
